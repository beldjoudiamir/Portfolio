      ...
      <nav className="container mx-auto px-2 py-0">
        <div className="flex justify-between items-center font-semibold">
          ...
          <div className="hidden md:flex space-x-4">
            <a href="#Accueil" className="hover:text-orange-400">
              Accueil
            </a>
          ...
          <div className="md:hidden">
            ...
            >
              {isOpen ? (
                <span className="material-symbols-outlined" id="symbolsMenu">
                  close
                </span>
              ) : (
                <span className="material-symbols-outlined" id="symbolsMenu">
        ...
        {isOpen && (
          <div className="mt-4 md:hidden text-center font-semibold">
            <a href="#" className="block hover:text-orange-400 mb-2">
              Accueil
            </a>
            <a href="#" className="block hover:text-orange-400 mb-2">
              À propos
